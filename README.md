...
![Routing](https://img.shields.io/badge/Routing-333333?style=flat)
![Status](https://img.shields.io/badge/Status-In%20Progress-yellow?style=flat)

- Fixing route matching behavior for static routes
- Investigating URL normalization in the underlying router
- Reproducing edge cases around trailing slashes and repeated slashes
